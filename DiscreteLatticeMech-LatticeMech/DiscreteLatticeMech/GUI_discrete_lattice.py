...
class MyFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.tool_1=self.frame_toolbar.AddTool(wx.ID_ANY, "icone_plus_point", wx.Bitmap("icone_plus_point.bmp", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.tool_2=self.frame_toolbar.AddTool(wx.ID_ANY, "icone_plus_poutre", wx.Bitmap("icone_plus_poutre.bmp", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.tool_3=self.frame_toolbar.AddTool(wx.ID_ANY, "icone_moins", wx.Bitmap("icone_moins.bmp", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
    ...
    def Open_file(self):
        ...
        try:
            ...
            self.Message_perso("Unable to parse file",wx.ICON_ERROR)
            myfile.close()
            return
        root=tree.getroot()
    ...
    def Calculation_letsdoit(self, event):
        ...
        try:
            ...
            self.multiText.write("Something wrong! Unable to do calcultions\n")        
        event.Skip()
